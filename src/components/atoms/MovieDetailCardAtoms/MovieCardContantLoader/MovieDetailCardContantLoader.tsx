    ...
    <AnimatePresence>
      {loading && (
        ...
        >
          ...
          >
            <rect x="12" y="12" rx="4" ry="4" width="205" height="186" />
            <rect x="228" y="12" rx="4" ry="4" width="120" height="186" />
            <rect x="12" y="237" rx="4" ry="4" width="336" height="38" />
            <rect x="12" y="315" rx="4" ry="4" width="336" height="38" />
            <rect x="12" y="393" rx="4" ry="4" width="336" height="38" />
          </ContentLoader>
        </motion.div>
      )}
    </AnimatePresence>
