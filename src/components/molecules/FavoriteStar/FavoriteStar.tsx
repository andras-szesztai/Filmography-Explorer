...
export default function FavoriteStar({ width }: Props) {
  ...
  return (
    <motion.svg width={width} viewBox="0 0 591.2 591.2">
      <motion.path
        ref={topRef}
        initial={{ fill: colors.accentSecondary }}
	...
	c3.7-2.8,5.6-7.3,4.9-11.9L380.6,338.8z"
      ...
      <motion.path
        fill="none"
        initial={{ fill: colors.bgColorSecondary }}
        strokeWidth={25}
        strokeLinecap="round"
	...
	c3.7-2.8,5.6-7.3,4.9-11.9L380.6,338.8z"
      ...
      {/* {circlesData.map((coors, i) => (
        <circle key={i} ref={circleRef.current[i]} {...coors} {...sharedCircleAttrs} />
      ))} */}
    </motion.svg>
  )
}
